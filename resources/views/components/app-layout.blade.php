...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div x-data="{ show: false, message: '' }" 
             x-init="
                @if(session('welcome'))
                    message = '{{ session('welcome') }}'; show = true; setTimeout(() => show = false, 3000);
                @elseif(session('exam_start'))
                    message = '{{ session('exam_start') }}'; show = true; setTimeout(() => show = false, 3000);
                @elseif(session('success'))
                    message = '{{ session('success') }}'; show = true; setTimeout(() => show = false, 3000);
                @endif
             "
             x-show="show"
