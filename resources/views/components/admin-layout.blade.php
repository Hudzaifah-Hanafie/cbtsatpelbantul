...
<body class="font-sans antialiased">
    ...
    <div class="h-screen flex overflow-hidden bg-gray-100" x-data="{ sidebarOpen: false }">
        ...
        <!-- Sidebar -->
        <aside
            class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto lg:flex lg:flex-col border-r border-gray-200"
            ...
            <header class="bg-white shadow-sm shrink-0 z-10 border-b border-gray-200">
                ...
                <div class="flex items-center justify-between px-4 py-3 lg:hidden">
                    <button @click="sidebarOpen = true"
                        class="p-2 -ml-2 text-gray-500 hover:text-indigo-600 focus:outline-none">
                ...
                <!-- Versi Desktop -->
                @if (isset($header))
                    <div class="hidden lg:flex items-center h-16 px-8">
                        <div class="max-w-7xl mx-auto w-full">
                            <h1 class="text-xl font-extrabold text-gray-900 tracking-tight"> {{ $header }}
                            </h1>
                        </div>
                    </div>
                @endif
